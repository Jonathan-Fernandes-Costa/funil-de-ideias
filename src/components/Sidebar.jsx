...
// Context para controlar o menu mobile globalmente
...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside className={`
        w-64 bg-blue-900 min-h-screen flex flex-col shadow-xl fixed left-0 top-0 z-50
      ...
      `}>
        ...
        {/* Logo da Empresa */}
        <div className="p-4 lg:p-6 border-b border-blue-800 flex items-center justify-between">
          <div>
          ...
          <button 
            onClick={close}
            className="lg:hidden text-white p-2 hover:bg-blue-800 rounded-lg"
          >
            ✕
          </button>
        </div>
...
// Componente do botão hamburger para o header mobile
